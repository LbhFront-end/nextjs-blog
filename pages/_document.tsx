...
export default function Document() {
  return (
    <Html>
      <Head>
        <meta name="application-name" content="赖同学" />
        ...
        <meta property="og:title" content="赖同学" />
        <meta property="og:description" content="前端知识学习分享" />
        <meta property="og:site_name" content="赖同学" />
        <meta property="og:url" content="https://laibh.com" />
        ...
        />
        <Script strategy="beforeInteractive" src="https://l2dwidget.js.org/lib/L2Dwidget.min.js" />
        <Script
        ...
        />
        <Script strategy="beforeInteractive" src="https://hm.baidu.com/hm.js?42b6e25f11511e5785c284cff52f342e" />
      </Head>
      <body>
        <Main />
        <NextScript />
